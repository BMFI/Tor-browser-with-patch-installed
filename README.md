# Tor-browser-with-patch-installed I did not create the Tor-Browser.
...
The code patch for root usage in kali and the tor browser was created by BMFI Jeff Rogers. You are required to keep this file with the code for download or redistribution.
